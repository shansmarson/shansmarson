...
#Error Msg
ytdError = Label(root,text="Error Msg",fg="red",font=("jost",8))
ytdError.grid()
...
#Download Quality
ytdQuality = Label(root,width=50,text="Select Quality",font=("jost",15))
ytdQuality.grid()
...
#developer Label
developerlabel = Label(root,text="CREATED BY SHANS MARSON",font=("jost",9))
developerlabel.grid()
root.mainloop()